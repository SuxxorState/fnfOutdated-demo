...
{    
    public static var changeState:FlxUIState = new TitleState();
    public static var font:String = Paths.font("vcr.ttf");
    public static var fontPath:String = "assets/fonts/vcr.ttf";
    public static var imagePath:String = 'achievements/ur_good'; 
...
class GameJoltLogin extends MusicBeatState
{
    ...
    override function create()
    {
		...
		charBop.frames = Paths.getSparrowAtlas('characters/mc', 'shared');
		charBop.animation.addByPrefix('idle', 'idle', 24, false);
...
class Toast extends Sprite
{
    ...
    public function new(iconPath:String, titleText:String, description:String, ?color:String = '#3848CC')
    {
        ...
        title.setTextFormat(new TextFormat(Paths.font("vcr.ttf"), 30, FlxColor.fromString(color), true));
        title.wordWrap = true;
        title.width = 360;
        ...
        desc.setTextFormat(new TextFormat(Paths.font("vcr.ttf"), 24, FlxColor.WHITE));
        desc.wordWrap = true;
        desc.width = 360;
        desc.height = 95;
