...
class ClientPrefs {
	public static var graphicContent:Bool = true;
	...
	public static function saveSettings() {
		FlxG.save.data.graphicContent = graphicContent;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.graphicContent != null) {
			graphicContent = FlxG.save.data.graphicContent;
		}
